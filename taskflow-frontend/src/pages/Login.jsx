    ...
    <div className="min-h-screen flex items-center justify-center bg-surface-50 p-3 sm:p-6">
      ...
      <div className="w-full max-w-md">
        <div className="mb-6 sm:mb-10 text-center">
          <h1 className="text-xl sm:text-3xl font-bold text-surface-900 tracking-tight mb-2">Welcome Back</h1>
          <p className="text-xs sm:text-base text-surface-500">Access your workspace</p>
        </div>
